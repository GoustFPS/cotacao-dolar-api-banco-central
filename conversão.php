...
<body>
    <main>
        ...
        // Mostrar o resultado (linux e IOS)
        // modo tradicional echo "Seus R\$" . number_format($real, 2, ",", ".") . " equivalem a US\$" . number_format($dolar, 2, ",", ".");

        // Formatação de moedas com internacionalozação!
